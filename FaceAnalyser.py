...
class FaceAnalyser(object):
    def __init__(self, user_name, cam_ID, cam_location):
...
def analyser(response_face_queue, user_name, cam_ID, cam_location):

    face_analyser = FaceAnalyser(user_name, cam_ID, cam_location)
